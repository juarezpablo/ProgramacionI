...
class Formulario_level(Form):
    def __init__(self,name, master_surface, x, y, w, h, color_background, estado, imagen_background, active):
        ...
        self.boton_nivel_1=Boton(self.surface,w/3,300,100,30,None,1,PATH_IMAGE+"gui/set_gui_01/Pixel_Border/Buttons/Button_M_03.png","Nivel 1","Comic Sans",C_PINK,20,self.elegir_nivel,"form_nivel_1")
        ...
        self.boton_nivel_2=Boton(self.surface,w/3,450,100,30,None,1,PATH_IMAGE+"gui/set_gui_01/Pixel_Border/Buttons/Button_M_03.png","Nivel 2","Comic Sans",C_PINK,20,self.elegir_nivel,"form_nivel_2")
       # self.lista_botones=[]
