...
class Player:
    def __init__(self,x,y,speed_walk,speed_run,gravity,jump_power,frame_rate_ms,move_rate_ms,jump_height,p_scale=1,interval_time_jump=100,tablero=1) -> None:
       ...
       # self.lives=[]
        ...
        self.score=0
        self.score_label=Caja_texto(tablero,500,0,100,50,C_NEGRO,"SCORE","Verdana",C_BLUE_2,35)
        self.score_value=Caja_texto(tablero,650,0,100,50,C_NEGRO,self.score,"Verdana",C_BLUE_2,35)
    '''
