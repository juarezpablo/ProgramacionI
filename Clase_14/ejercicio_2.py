...
domicilio = persona_1.get("domicilio")
domicilio.update({"calle":"Ramon Franco", "altura" : 5050 })

persona_1.update({"domicilio" : domicilio})
print(persona_1)
...
lista_telefonos = persona_1.get("telefonos")
for diccionario in lista_telefonos:
    if "trabajo" not in diccionario.keys() :
